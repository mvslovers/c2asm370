...
#if defined(S390) || defined(I386) || defined(HOST_LINUX) || defined(HOST_MACOS)
...
#if defined(HOST_LINUX) || defined(HOST_MACOS)
#include <fcntl.h>
#include <unistd.h>
#else
#include "unixio.h"
...
#if defined(HOST_MACOS) || defined(__LP64__)
...
/* Define if the host machine stores words of multi-word integers in
   big-endian order. */
#if !defined(HOST_MACOS) && !defined(HOST_LINUX)
